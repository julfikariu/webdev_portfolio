<template>
    <div>
        <!-- Header & Navigation -->
        <header class="fixed w-full top-0 z-50 h-18  bg-gray-900 dark:bg-gray-100 bg-opacity-80 backdrop-blur-sm shadow-sm">
            <nav class="container mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
                ...
                <ul class="hidden md:flex items-center space-x-6 font-medium text-gray-300 dark:text-gray-700">
                    ...
                    <li><a href="#experience" class="hover:text-teal-400 transition-colors duration-300">Experience</a>
                    </li>
                    ...
                    <li><a href="#education" class="hover:text-teal-400 transition-colors duration-300">Education</a>
                    </li>
                    <li><a href="#contact" class="hover:text-teal-400 transition-colors duration-300">Contact</a></li>

                    <!-- Dark Mode Toggle (Desktop) -->
                    <li>
                        <button @click="toggleTheme" id="theme-toggle-desktop"
                            class="focus:outline-none cursor-pointer">
                            <i :class="darkMode ? 'fas fa-moon text-yellow-400' : 'fas fa-sun text-yellow-400'"
                                class="text-xl hover:text-yellow-300 transition-colors duration-300"></i>
                        </button>
                    </li>
                </ul>
                ...
                <div class="flex items-center md:hidden space-x-4">
                    <button id="theme-toggle-mobile" @click="toggleTheme" class="focus:outline-none cursor-pointer">
                        <i :class="darkMode ? 'fas fa-moon text-yellow-400' : 'fas fa-sun text-yellow-400'"
                            class="text-xl hover:text-yellow-300 transition-colors duration-300 cursor-pointer"></i>
                    </button>
                </div>
            </nav>
        </header>
